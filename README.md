...
注意：此类 公开节点来源不明（包括付费节点），不建议经常使用，最好只用于过渡使用，重点使用下面的方法  ，下面几种方法 使用都需要借助方法1临时连接国际互联网           
...
下载地址 https://f-droid.org/zh_Hans/             

## 3.        
第一种方式联机以后 ，也可以下载 protonvpn   https://f-droid.org/packages/ch.protonvpn.android/   
...
2. 使用 Gmail 或 Riseup 的邮箱服务发送邮件到 `frontdesk@torproject.org`，并且邮件主题需要包含`private bridge cn`           
